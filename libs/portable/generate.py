...
def write_package_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("rd".encode(encoding=encoding))
...
# Windows: python3 .\generate.py -f ..\rd\flutter\build\windows\x64\runner\Release\ -o . -e ..\rd\flutter\build\windows\x64\runner\Release\rd.exe
